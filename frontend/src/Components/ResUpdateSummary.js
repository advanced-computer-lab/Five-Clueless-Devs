        ...
        switch (cabin) {
            case "Economy":
                ...
                if (window.location.href.includes("Dept")) {
                    ...
                    deptFlightOld = { ...deptFlightOld, availableEconomy: deptFlightOld.availableEconomy + numOfSeats };
                }
                else if (window.location.href.includes("Ret")) {
                    retFlight = { ...retFlight, availableEconomy: retFlight.availableEconomy - numOfSeats };
                    retFlightOld = { ...retFlightOld, availableEconomy: retFlightOld.availableEconomy + numOfSeats };
                }
                break;
            case "First":
                if (window.location.href.includes("Dept")) {
                    deptFlight = { ...deptFlight, availableFirst: deptFlight.availableFirst - numOfSeats };
                    deptFlightOld = { ...deptFlightOld, availableFirst: deptFlightOld.availableFirst + numOfSeats };
                }
                else if (window.location.href.includes("Ret")) {
                    retFlight = { ...retFlight, availableFirst: retFlight.availableFirst - numOfSeats };
                    retFlightOld = { ...retFlightOld, availableFirst: retFlightOld.availableFirst + numOfSeats };
                }
                break;
            case "Business":
                if (window.location.href.includes("Dept")) {
                    deptFlight = { ...deptFlight, availableBusiness: deptFlight.availableBusiness - numOfSeats };
                    deptFlightOld = { ...deptFlightOld, availableBusiness: deptFlightOld.availableBusiness + numOfSeats };
                }
                else if (window.location.href.includes("Ret")) {
                    retFlight = { ...retFlight, availableBusiness: retFlight.availableBusiness - numOfSeats };
                    retFlightOld = { ...retFlightOld, availableBusiness: retFlightOld.availableBusiness + numOfSeats };
                }
                break;
            default:
